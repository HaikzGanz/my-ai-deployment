    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col h-full w-[260px]">
          ...
          {/* Chat list */}
          <div className="flex-1 overflow-y-auto overflow-x-hidden px-2 space-y-4 scrollbar-thin">
            {groupedChats.map(group => (
              <div key={group.label}>
                <div className="px-2 py-1.5 text-xs font-medium text-gray-500 sticky top-0 bg-[#171717]">
                  {group.label}
                </div>
          ...
          <div className="border-t border-white/10 p-2">
            <button
              ...
              className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg hover:bg-white/[0.06] transition-colors text-gray-300 hover:text-white"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
